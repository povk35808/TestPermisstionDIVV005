...
        openLeaveRequestBtn.classList.remove('bg-white/60', 'hover:bg-white/80'); // Removed glass classes
...
        openLeaveRequestBtn.classList.add('bg-white/60', 'hover:bg-white/80'); // Added glass classes
...
        openOutRequestBtn.classList.remove('bg-white/60', 'hover:bg-white/80'); // Removed glass classes
...
        openOutRequestBtn.classList.add('bg-white/60', 'hover:bg-white/80'); // Added glass classes
...
            elements.returnTime.textContent = data.returnedAt || 'N/A';S
...
                showCustomAlert("សូម Screenshot", "Browser នេះមិនគាំទ្រ Web Share API ទេ។ សូមធ្វើការ Screenshot វិក័យប័ត្រនេះដោយដៃ រួច Share ទៅ Telegram។");s
            } 
...
        const cardElement = btn.closest('.bg-white\\/70'); // Updated selector
